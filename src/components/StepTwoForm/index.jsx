        ...
        <div className='sign-up-form'>
            ...
            <form className='step-two-form'>
                ...
                <div className='container-email-step-two-form container-input'>
                    <span className='step-two-form-email span-forms'>Repita a senha*</span>
                    <input
            ...
            <div className='container-step-two-form-button'>
                <button className='step-two-next-page-button' onClick={handleSubmitStepOne}>Finalizar cadastro</button>
            </div>
            <div className='container-step-two-form-subtitle'>
                <span className='step-two-form-subtitle'>Já tem uma conta? Faça seu <a href="#">Login</a> </span>
            </div>
        </div>
    )
}
